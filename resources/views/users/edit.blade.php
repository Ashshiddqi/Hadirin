...
<body class="min-h-screen">
  ...
  <div class="max-w-3xl mx-auto p-4 sm:p-6 relative z-10">
    <!-- Main Card -->
    <div class="card rounded-lg overflow-hidden">
      <!-- Card Header -->
      <div class="px-6 py-4 border-b bg-gradient-to-r from-primary-600 to-primary-700">
        <h2 class="text-lg font-semibold text-white flex items-center">
          <i class="ph ph-user-circle-gear mr-2"></i> Form Edit User
        </h2>
      </div>
      ...
      <div class="p-6">
        ...
        <!-- Success Message -->
        @if(session('success'))
          <div class="mb-6 p-4 bg-green-900 bg-opacity-20 border-l-4 border-green-500 rounded-lg">
            <div class="flex items-center">
          ...
          <div>
            ...
            <div class="relative rounded-md shadow-sm">
              ...
              <select 
                name="gender" 
                id="gender"
                class="form-select block w-full pl-10 py-2 rounded-md focus:ring-primary-500 focus:border-primary-500"
              >
